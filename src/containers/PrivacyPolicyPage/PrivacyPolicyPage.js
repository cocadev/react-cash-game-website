	...
	render() {
		...
		return (
			<div className={classes.privacy}>
				...
				<h3><b>Island Treasure Terms of Use, including Official Rules for Island Treasure Sweepstakes &amp; Instant Win</b></h3>
				<h5><b>Effective January 1, 2016</b></h5>
				<p>Welcome to Island Treasure, a service that lets users of smartphones and other mobile devices play fun games and have the chance to win prizes in our Sweepstakes (as defined below) (the "Service"). The Service, along with our website at www.IslandTreasure.co (the "Site" and, together, with the Service, our "Services") is owned and operated by Island Treasure Co, Inc. ("Island Treasure Co," "Sponsor," "we," or "us"). These Terms of Use, including the Official Rules for the Island Treasure Sweepstakes &amp; Instant Win (these "Terms and Official Rules") govern your use of and access to the Services and your participation in the Sweepstakes.</p>
				...
				<ul>
					...
					<li>We may collect registration information and other information about you through the Services. Our collection, use, and disclosure of this information is governed by our <b><a title="privacy-policy" href="https://IslandTreasure.co/privacy-policy/" className="green">Privacy Policy</a></b>.</li>
				</ul>
				<ul>
					<li>
				...
				<ul>
					...
					<li>The services provided under these Terms and Official Rules are offered by Island Treasure Co, located at PO Box 87, New York, NY 10018. You may contact us by sending correspondence to the foregoing address or by emailing us at <a href="mailto:support@IslandTreasure.co?subject=Regarding:%20Disclosures%20(from%20IslandTreasure.co/terms)" className="green">support@IslandTreasure.co</a>. If you are a California resident, you may have these Terms and Official Rules mailed to you electronically by sending a letter to the foregoing address with your electronic mail address and a request for these Terms and Official Rules.</li>
				</ul>
			</div>
		);
	}
